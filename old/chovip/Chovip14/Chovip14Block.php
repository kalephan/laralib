...
class Chovip14Block
{
    ...
    public function contentBottomProductAccess(&$block)
    {
        ...
        return ! in_array($lks->request->prefix(), $unsupport_prefix) && ! in_array($lks->request->segment(0), $unsupport_segment_0);
    }
    ...
    public function blockEcShopRegisterAccess(&$block)
    {
        ...
        return $lks->request->segment(0) == 'shop' && ($lks->request->segment(1) == 'create' || in_array($lks->request->segment(2), [
            'confirmation',
            'finalize'
        ]));
    }
