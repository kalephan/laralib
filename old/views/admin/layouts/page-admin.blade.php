...
@section('body')
    @if ($regions['admin menu'])
    <div id="admin_menu" class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="{{lks_url('{backend}/')}}">{{config('lks.sitename', 'LKS CMS')}}</a>
        </div>
    ...
    <div id="main_content" class="container">
        ...
        <div id="center"><div id="squeeze" class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div id="content">
                    {{ $regions['admin content top'] }}

                    @if($cl = lks_instance_get()->response->getFlash('contextual-link'))
                        <div id="contextual-link">{{$cl}} </div>
                    @endif

                    {{ $content }}
                    {{ $regions['admin content bottom'] }}
                </div>
            </div>
        </div></div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><iframe id="myModal-frame" name="myModal-frame" frameborder="0"></iframe></div></div></div>
