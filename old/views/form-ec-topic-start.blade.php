<div id="shop_topic_create" class="clearfix">
    ...
    <div class="tab_list_step">
      <ul>
        <li><a href="#" class="active_list_step">Lựa Chọn Danh Mục Bạn Muốn Đăng Tin</a></li>
    ...
    <div class="wrapper_box_list_step box_content mar_bottom7">
      <div class="categories_select_boxes">
        <div id="category_level_1_group">
          {{ lks_form_render('category_level_1', $form) }}
        </div>
        <div id="category_level_2_group"><span class="glyphicon glyphicon-chevron-right iconArrowRight"></span>
          {{ lks_form_render('category_level_2', $form) }}
        </div>
        <div id="category_id_group"><span class="glyphicon glyphicon-chevron-right iconArrowRight"></span>
