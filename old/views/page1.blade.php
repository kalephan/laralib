@extends('layouts.html') @section('body')
<div id="header" class="container">{{ $regions['header'] }}</div>
...
<div id="primary_menu" class="navbar navbar-default" role="navigation">
	<div class="container">
		...
		<div class="collapse navbar-collapse">{{ $regions['primary menu'] }}</div>
	</div>
</div>
...
<div id="main_content" class="container">
	...
	<div id="sidebar_left" class="sidebar sidebar_left">{{ $regions['left
		sidebar'] }}</div>
	@endif
	...
	<div id="sidebar_right" class="sidebar sidebar_right">{{
		$regions['right sidebar'] }}</div>
	@endif
</div>

@if($regions['secondary menu'])
<div id="secondary_menu" class="container">{{ $regions['secondary menu']
	}}</div>
@endif @if($regions['footer'])
<div id="footer" class="container">{{ $regions['footer'] }}</div>
@endif
